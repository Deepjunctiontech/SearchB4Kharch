package in.junctiontech.searchb4kharch.anim;
...
public class AnimationUtils {
    ...
    public static void scaleXYV(View holder) {
        holder.setScaleX(0);
        holder.setScaleY(0);
        PropertyValuesHolder propx = PropertyValuesHolder.ofFloat("scaleX", 1);
        PropertyValuesHolder propy = PropertyValuesHolder.ofFloat("scaleY", 1);

        ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(holder, propx, propy);
        animator.setDuration(800);
        animator.start();
    }

    public static void scaleXYVishal(NetworkImageView holder) {
        holder.setScaleX(0);
        holder.setScaleY(0);
        PropertyValuesHolder propx = PropertyValuesHolder.ofFloat("scaleX", 1);
        PropertyValuesHolder propy = PropertyValuesHolder.ofFloat("scaleY", 1);
...
//        animatorSet.start();
    ...
    //
    public static void vishal(RecyclerView.ViewHolder holder, boolean goesDown) {

      //  int holderHeight = holder.itemView.setPivotY(goesDown == true ? 0 : holderHeight);
        int holderHeight = holder.itemView.getHeight();
        holder.itemView.setPivotY(goesDown == true ? 0 : holderHeight);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holder.itemView, "translationY", goesDown == true ? 300 : -300, 0);
